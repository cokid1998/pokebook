...
function SearchBar() {
  ...
  return (
    ...
    >
      ...
      {/* 드롭다운 메뉴 */}
      {isExpand && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden">
